...
dependencies {
    ...
    implementation 'com.confirmit.mobilesdk:mobilesdk:3.8.1'
}
```
...
let package = Package(
    ...
    dependencies: [
		.package(url: "https://github.com/FortaGlobal/DigitalFeedbackMobileSDK.git", .upToNextMajor(from: "3.8.1"))
    ],
    targets: [
        .target(
