...
dependencies {
    ...
    implementation 'com.confirmit.mobilesdk:mobilesdk:3.10.2'
}
```
...
let package = Package(
    ...
    dependencies: [
		.package(url: "https://github.com/ForstaGlobal/DigitalFeedbackMobileSDK.git", .upToNextMajor(from: "3.10.2"))
    ],
    targets: [
        .target(
