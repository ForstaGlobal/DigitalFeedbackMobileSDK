...
dependencies {
    ...
    implementation 'com.confirmit.mobilesdk:mobilesdk:3.11.0'
}
```
...
let package = Package(
    ...
    dependencies: [
		.package(url: "https://github.com/ForstaGlobal/DigitalFeedbackMobileSDK.git", .upToNextMajor(from: "3.11.0"))
    ],
    targets: [
        .target(
