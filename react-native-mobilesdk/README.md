...
dependencies {
    ...
    implementation 'com.confirmit.mobilesdk:mobilesdk:4.0.1'
}
```
...
let package = Package(
    ...
    dependencies: [
		.package(url: "https://github.com/ForstaGlobal/DigitalFeedbackMobileSDK.git", .upToNextMajor(from: "4.0.1"))
    ],
    targets: [
        .target(
